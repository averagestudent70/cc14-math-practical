/*
    ...
    NOTES:
    1. Remove the code for printing the difference table and its output 
    when pasting to assignment file.

    2. Incomplete

    Output:
    Interpolation using Newton's Forward Interpolation fourmula
    ...
    8
    The functional value at x = 0.250000 is 1.3078724508
*/
